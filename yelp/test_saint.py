...
def train(model, loader, optimizer, device, epoch, args):
    ...
    if epoch > args.load_CL:
        ...
        for data in loader:
            ...
            y1 = data.y[data.test_mask]
            loss_test = criterion(out1, y1)
        ...
        for data in loader:
            ...
            out1 = y_pre[data.test_mask]
            y1 = data.y[data.test_mask].to(torch.float)
            loss_test = criterion(out1, y1)
...
for run in range(args.runs):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch == args.epochs:
            print('train_loss:', losslist.tolist())
            print('test_loss:', losstest.tolist())
